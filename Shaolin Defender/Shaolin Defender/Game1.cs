...
namespace Shaolin_Defender
{
    ...
    public class Game1 : Game
    {
       ...
       // Animation myPlayerAnimation;
        ...
        Texture2D playerTexture, playerTextureLeft;
        Texture2D coins;
        Texture2D fireStick;
        Texture2D blur;
        //animation
        ...
        protected override void LoadContent()
        {
            ...
            playerTexture = this.Content.Load<Texture2D>("new/playerRun");
            //playerTextureLeft = this.Content.Load<Texture2D>("new/playerRunLeft");
