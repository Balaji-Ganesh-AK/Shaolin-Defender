...
namespace Shaolin_Defender
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            // testing 
            //player = new Texture2D(this.GraphicsDevice, 100 , 100);
            //Color[] colorData = new Color[100*100];
            //for (int i = 0; i < 10000; i++)
            //    colorData[i] = Color.Black;
            //player.SetData<Color>(colorData); // color of the cube ; 
            // playerPos.X = (Window.ClientBounds.Width - player.Width) / 2;
            // playerPos.Y = (Window.ClientBounds.Height - player.Height);
        ...
        protected override void LoadContent()
        {
            ...
            // testing 
            player = this.Content.Load<Texture2D>("RedBoi");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.W) && playerPos.Y >= 10)
                playerPos.Y -= speed;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(coins, coinPos, null, Color.White, 0f, Vector2.Zero, 0.1f, SpriteEffects.None, 0f);
