...
namespace Shaolin_Defender
{
    class Animation
    {
        ...
        public void Draw(SpriteBatch sprite, Rectangle sourceRectangle, Vector2 position, float rotation, Vector2 origin, float size)
        {
            //origin = new Vector2(sourceRectangle.Width/9 , sourceRectangle.Height/9);
            sprite.Draw(animation, position, sourceRect, Color.White, rotation, new Vector2(frameWidth / 2, frameHeight / 2), size, SpriteEffects.None, 0);
